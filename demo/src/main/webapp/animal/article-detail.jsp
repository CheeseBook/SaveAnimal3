...
<head>
    ...
    <title>文章详情页</title>
    <link rel="stylesheet" media="screen" href="${pageContext.request.contextPath}/html/article/blog.show.49036fb65c22810512f1.bundle.css">
    <meta content="width=device-width, initial-scale=1.0" id="viewport" name="viewport">
    <!-- CUSTOM_CODE_START -->
    <!-- CUSTOM_CODE_END -->
    <link rel="stylesheet" media="screen" href="${pageContext.request.contextPath}/html/article/main.css">
        ...
        <div class="s-blog-content  ">
            <div class="s-blog-header">
                <div class="s-blog-header-inner s-bg-image s-bg-blurred s-bg-light-text s-bg-overlay _animate-background background-image lazyloaded"
                     data-bg="${pageContext.request.contextPath}/html/article/yemeitu.jpg"
                     data-react-style="{&quot;backgroundRepeat&quot;:&quot;no-repeat&quot;,&quot;backgroundSize&quot;:&quot;cover&quot;,&quot;backgroundColor&quot;:&quot;transparent&quot;,&quot;backgroundPosition&quot;:&quot;50% 50%&quot;}"
                     style="background-repeat: no-repeat; background-size: cover; background-color: transparent; background-position: 50% 50%; background-image: url(&quot;${pageContext.request.contextPath}/html/article/yemeitu.jpg&quot;);">
