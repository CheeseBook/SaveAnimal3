        ...
        <div class='container'>
            <div class='collapse navbar-collapse'>
                <ul>
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/animal/save.jsp">救助动物</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/animal/share.jsp">暖心分享</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/animal/activity.jsp">志愿活动</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/animal/forlove.jsp">为爱发电</a>
...
<script type="text/javascript">
    ...
    //     if(t>0){
    //         $('nav.navbar.navbar-default').addClass('nav-active')
    //     }else{
    //         $('nav.navbar.navbar-default').removeClass('nav-active')
    //     }
    // })
