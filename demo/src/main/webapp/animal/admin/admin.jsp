            ...
            <div class="panel-body">
                <form class="form-inline" method="get" onsubmit="return false;">
                    <div class="form-group">
                        <label for="findByName">管理员账号</label>
                ...
                <form class="form-inline" method="get" onsubmit="return false;" style="margin-top: 20px;">
                    <button type="button" class="btn btn-primary" id="all_admins">查询全部管理员</button>
                </form>
            </div>
        </div>
...
<div class="modal fade" id="newAdmin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" style="margin-top: 128px;">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="new_admin_form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="new_adminName" placeholder="管理员账号"
                                   name="adminUsername">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="new_Name" placeholder="真实名字" name="adminName">
                        </div>
                        <label for="new_sex" class="col-sm-2 control-label">
                            性别
                        </label>
                        <div class="col-sm-4">
                            <select class="form-control" id="new_sex" name="adminSex">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="new_age" placeholder="年龄" name="adminAge">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="new_email" placeholder="电子邮箱" name="adminEmail">
                        </div>
                    </div>
        ...
        <div class="modal-content" style="width: 602px;">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="edit_admin_form" method="post" enctype="multipart/form-data">
                    <input type="hidden" id="edit_id" name="adminId">
                    <div class="form-group">
                        <label for="edit_adminUsername" class="col-sm-2 control-label">
                            管理员账号
                        </label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_adminUsername" placeholder="管理员账号"
                                    name="adminUsername">
                        </div>
                        <label for="edit_adminPassword" class="col-sm-2 control-label">
                            管理员密码
                        </label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_adminPassword" placeholder="用户密码"
                                    name="adminPassword">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_adminName" placeholder="真实名字"
                                    name="adminName">
                        </div>
                        <label for="edit_adminSex" class="col-sm-2 control-label">
                            性别
                        </label>
                        <div class="col-sm-4">
                            <select class="form-control" id="edit_adminSex"  name="adminSex">
                                <option value="男">男</option>
                                <option value="女">女</option>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        <label for="edit_adminAge" class="col-sm-2 control-label">
                            年龄
                        </label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_adminAge" placeholder="年龄"
                                    name="adminAge">
                        </div>
                        <label for="edit_adminTele" class="col-sm-2 control-label">
                            电话号码
                        </label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_adminTele" placeholder="电话"
                                    name="adminTele">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="edit_adminEmail" class="col-sm-2 control-label">
                            电子邮箱
                        </label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_adminEmail" placeholder="电子邮箱"
                                    name="adminEmail">
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    function build_admins_table(result) {
        ...
        $.each(admins, function (index, admin) {
            ...
            var adminNameTd = $("<td></td>").append(admin.adminUsername);
            var realNameTd = $("<td></td>").append(admin.adminName);
            var telephoneTd = $("<td></td>").append(admin.adminSex);
            var emailTd = $("<td></td>").append(admin.adminAge);
            var birthdayTd = $("<td></td>").append(admin.adminTele);
            var adminEmail = $("<td></td>").append(admin.adminEmail);
    ...
    $(document).on("click", ".edit_btn", function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                //填充用户信息
                $("#edit_id").val(id);
                $("#edit_adminUsername").val(result.extend.admin.adminUsername);
                $("#edit_adminPassword").val(result.extend.admin.adminPassword);
                $("#edit_adminName").val(result.extend.admin.adminName)
                $("#edit_adminSex").val(result.extend.admin.adminSex);
                $("#edit_adminAge").val(result.extend.admin.adminAge);
                $("#edit_adminTele").val(result.extend.admin.adminTele);
                $("#edit_adminEmail").val(result.extend.admin.adminEmail);
            }
        });
        //2、弹出模态框
        $("#editAdmin").modal({
    ...
    $(document).on("click", ".delete_btn", function () {
        //1、弹出是否确认删除对话框
        var adminUsername = $(this).parents("tr").find("td:eq(1)").text();
        var adminId = $(this).parents("tr").children("td")[0].innerText
        if (confirm("确认删除管理员账号【" + adminUsername + "】吗？")) {
            //确认，发送ajax请求删除即可
            $.ajax({
    ...
    function to_findByName(pn, adminName) {
        $.ajax({
            ...
            type: "POST",
            dataType: "json",
            data: {"pn": pn, "adminUsername": adminName},
            async: "true",
            success: function (result) {
